...
/**
 * Test case for class VMeC\VmecEvents\Controller\EventController.
 *
...
class EventControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \VMeC\VmecEvents\Controller\EventController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('VMeC\\VmecEvents\\Controller\\EventController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllEventsFromRepositoryAndAssignsThemToView() {
		...
		$eventRepository = $this->getMock('VMeC\\VmecEvents\\Domain\\Repository\\EventRepository', array('findAll'), array(), '', FALSE);
	...
	public function showActionAssignsTheGivenEventToView() {
		$event = new \VMeC\VmecEvents\Domain\Model\Event();
